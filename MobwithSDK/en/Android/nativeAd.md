...
| setCategory(List<String> categories)                            | Category targeting ad feature      |
...
|      adImageViewID      | The layout ID of the ImageView that will display the ad Image (If not used, set it to -1.)                                                                |
|    adLogoImageViewID    | The layout ID of the ImageView that will display the advertiser logo (If not used, set it to -1.)                                                          |
|       titleViewID       | The layout ID of the TextView that will display the ad Title (If not used, set it to -1.)                                                                 |
|    descriptionViewID    | The layout ID of the TextView that will display the ad description (If not used, set it to -1.)                                                            |
|    gotoSiteButtonID     | The layout ID of the TextView that will display the message for navigating to the ad site (If not used, set it to -1.)                                    |
| infoLogoViewContainerID | The ViewGroup layout ID wrapping the ImageView that will display the ad Info Logo. Used for AppLovin mediation. (If not used, set it to -1.)               |
|   infoLogoImageViewID   | The layout ID of the ImageView that will display the ad Info Logo (If not used, set it to -1.)                                                             |
