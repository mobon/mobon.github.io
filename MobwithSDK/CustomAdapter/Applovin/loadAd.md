...
- #### Custom Network 설정
<h5> 위 설정한 광고 Unit에 Custom Network를 설정합니다. 이 후 Mobwith에서 발급받은 unitId를 Custom Parameters에 예시 Json 포맷(예시 : {"unitId":"00000000"})에 맞춰 설정합니다.</h5>
...
| **Custom Parameters** | Mobwith 광고 로드 시 사용할 지면 번호 입니다. 예시를 참고하여 반드시 Json 포맷을 맞춰주세요. ( 예시 : {"unitId":"00000000"} ) |
